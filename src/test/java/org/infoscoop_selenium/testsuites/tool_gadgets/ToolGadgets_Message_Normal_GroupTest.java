...
//    @Test
     ...
     * グループにメッセージを送信する
     */
    public void iscp_4222() {
        /*
         * グループ宛てメッセージ送信フォームからメッセージを送信した場合、選択したグループに含まれる各ユーザに対するダイレクトメッセージとして送信されることを確認。
         * (自分自身がグループに含まれる場合は、メールシステムと同じように自分自身にメッセージが送信される)
         */
    }
...
//    @Test
     ...
     * ユーザのRSSを追加
     */
    public void iscp_4223() {
        /*
         * ユーザ名の右側のRSS追加アイコンをクリックすると、選択したユーザの発言を含むRSSを読み込むRSSリーダーがカレントタブの左上に追加されることを確認。
         */
    }
...
//    @Test
     ...
     * ユーザ宛てメッセージ送信フォームを開く
     */
    public void iscp_4224() {
        /*
         * ユーザ名の右側にあるメッセージアイコンをクリックすると、メッセージ送信フォームが開くことを確認。
         * また、このときフォームのタイトルは[{メール編集アイコン}<ユーザ名>へメッセージを送る]と表示されていることを確認。
         */
    }
...
//    @Test
     ...
     * ユーザにメッセージを送信する
     */
    public void iscp_4225() {
        /*
         * ユーザ宛てメッセージ送信フォームからメッセージを送信した場合、選択したユーザに対するダイレクトメッセージとして送信されることを確認。
         */
    }
