...
public class ToolGadgets_Alarm_Settings_HourTest extends IS_BaseItTestCase {
	...
	public void iscp_4002(){
		...
		// 不正な文字を入力
		GADGET.getHourElement().sendKeys("ABC");
	...
	public void iscp_4003(){
    	...
    	assertTrue(msg, msg.indexOf("時 が未入力です。") >= 0);
	}
}
